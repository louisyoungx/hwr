...
def test_one_action_updates_left_and_right_arm_and_gripper_targets() -> None:
    ...
    try:
        ...
        initial_left = backend._left_targets.copy()  # noqa: SLF001 - adapter contract test
        ...
        left_control = backend.data.ctrl[list(backend.bundle.ids.secondary_arm_actuators)]
        right_control = backend.data.ctrl[list(backend.bundle.ids.arm_actuators)]
