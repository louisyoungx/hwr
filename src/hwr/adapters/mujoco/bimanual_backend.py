...
class MujocoBimanualTaskBackend(MujocoDualArmBackend):
    ...
    def task_audit(self) -> dict[str, object]:
        ...
        return {
            ...
            "left_contact_steps": self.tracker.left_contact_steps,
            "right_contact_steps": self.tracker.right_contact_steps,
            "simultaneous_contact_steps": self.tracker.simultaneous_contact_steps,
